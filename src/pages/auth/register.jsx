        ...
        <div className="px-6 2xl:px-36 xl:px-28 lg:px-20 md:px-10">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute transform -translate-y-1/2 right-8 top-1/2 text-light-secondary text-[15px]"
                >
            ...
            >
              ...
              />
              <span className="ml-4 text-[15px] text-light-default">
                I agree to the
          ...
          <div className="grid w-full xl:grid-cols-[40%_60%] grid-cols-[30%_70%] py-4 mb-4 rounded-lg shadow-lg bg-light-default text-dark-default cursor-pointer">
            ...
            <div className="grid items-start justify-start">
              <button className="text-[15px]">Register with Google</button>
            </div>
          </div>
          ...
          <div className="grid w-full xl:grid-cols-[40%_60%] grid-cols-[30%_70%] py-4 mb-4 rounded-lg shadow-lg bg-light-default text-dark-default cursor-pointer">
            ...
            <div className="grid items-start justify-start">
              <button className="text-[15px]">Register with Facebook</button>
            </div>
          </div>
        </div>
      </div>
